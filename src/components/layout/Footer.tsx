...
export default function Footer() {
  ...
  return (
    <footer className="bg-card text-card-foreground border-t mt-12">
      <div className="container max-w-screen-xl px-4 sm:px-6 lg:px-8 py-8 flex flex-col items-center justify-center gap-4">
          <AiAssistant />
          <p className="text-sm text-muted-foreground">تحتاج مساعدة؟ تحدث إلى المساعد الذكي.</p>
      </div>
