...
export const FirebaseProvider: React.FC<FirebaseProviderProps> = ({
  ...
  const reloadUser = useCallback(async () => {
    ...
    if (currentUser) {
      try {
        ...
        // Optionally handle user reload error
      }
    }
  }, [auth]);
  ...
  }, [firebaseApp, firestore, auth, storage, userAuthState, reloadUser]);
...
export const useUser = (): UserHookResult => { // Renamed from useAuthUser
  const { user, isUserLoading, userError, reloadUser } = useFirebase(); // Leverages the main hook
