...
export default function Home() {
  ...
  return (
    <div className="flex flex-col gap-10 max-w-7xl mx-auto pb-20 animate-in fade-in duration-1000">
      ...
      {/* Row: Clock and Greeting Cards */}
      <div className="flex flex-col md:flex-row gap-6 items-stretch">
        {/* Left Card: Local Time */}
        ...
        {/* Right Card: Greeting Wrapper */}
        <Card className="flex-[2] border-0 shadow-xl rounded-[2.5rem] bg-gradient-to-l from-blue-600 to-blue-400 text-white overflow-hidden relative">
      ...
      {/* Main Dashboard Platform (Dark Platform) */}
